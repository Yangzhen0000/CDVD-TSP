...
def make_model(args):
    ...
    recons_pretrain_fn = ''
    is_mask_filter = True
    return VBDE_RESIDUAL(in_channels=args.n_colors, n_sequence=args.n_sequence, out_channels=args.n_colors,
...
class VBDE_RESIDUAL(nn.Module):
    ...
    def __init__(self, in_channels=3, n_sequence=3, out_channels=3, n_resblock=3, n_feat=32,
        ...
        super(VBDE_RESIDUAL, self).__init__()
        print("Creating VBDE_RESIDUAL Net")
